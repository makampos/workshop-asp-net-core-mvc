...

{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Maria Gree", "maria@gmail.com", new DateTime(1979 ,12 ,22),2000.00,d2);
            Seller s3 = new Seller(3, "Marcelo Boyka", "Boyka@gmail.com", new DateTime(1974, 12, 22), 2000.00, d3);
            Seller s4 = new Seller(4, "Chester Bennington", "Bennington@gmail.com", new DateTime(2000, 12, 22), 2000.00, d4);
            Seller s5 = new Seller(5, "Corey Tyler", "Corey@gmail.com", new DateTime(1999, 12, 22), 2000.00, d2);
            Seller s6 = new Seller(6, "Emy Lee", "Lee@gmail.com", new DateTime(1939, 12, 22), 2000.00, d3);
            Seller s7 = new Seller(7, "Alex smalovisk", "smalovisk@gmail.com", new DateTime(1929, 12, 22), 2000.00, d1);
            Seller s8 = new Seller(8, "Pietrik Hamazin Vladumankastri", "Vladumankastri@gmail.com", new DateTime(1814, 12, 22), 2000.00, d4);
